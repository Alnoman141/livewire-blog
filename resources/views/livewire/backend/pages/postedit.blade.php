   ...
   <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
    ...
    <div class="rounded overflow-hidden shadow bg-white m-6 w-full">
        <div class="px-6 border-b border-light-grey py-5 flex">
            <h2 class="font-bold text-xl">Edit Post</h2>
                ...
                <div class="p-3">
                    ...
                    <form class="w-full" wire:submit.prevent="update">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-3/4">
                                <input wire:model.debounce.500ms="title" class="bg-white appearance-none border border-grey-600 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:border focus:bg-white focus:border-purple-light" id="title" type="text">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-3/4">
                                <img src="{{asset('storage/post-image/'.$post->image)}}" width="250px">
                            </div>
                        </div>
                        <div class="md:flex md:items-center mb-6">
                            <div class="md:w-1/4">
