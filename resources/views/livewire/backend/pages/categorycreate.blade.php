   ...
   <div class="flex flex-1 flex-col md:flex-row lg:flex-row mx-2">
    ...
    <div class="rounded overflow-hidden shadow bg-white m-6 w-full">
        <div class="px-6 border-b border-light-grey py-5 flex">
            <h2 class="font-bold text-xl">Add New Category</h2>
                ...
                <div class="p-3">
                    ...
                    <form class="w-full" wire:submit.prevent="store">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-3/4">
                                <input wire:model.debounce.500ms="name" class="bg-white appearance-none border border-grey-600 rounded w-full py-2 px-4 text-grey-darker leading-tight focus:border focus:bg-white focus:border-purple-light" id="name" type="text" placeholder="Enter Category Name">
                        ...
                        <div class="md:flex md:items-center mb-6">
                            ...
                            <div class="md:w-3/4">
                                <select class="mb-3 block appearance-none w-full bg-grey-200 border border-grey-200 text-grey-darker py-3 px-4 pr-8 rounded leading-tight focus:outline-none focus:bg-white focus:border-grey" id="parent_id" wire:model="parent_id">
